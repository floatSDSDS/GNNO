...
class DirectAUC5(GeneralModel):
    reader = 'BaseReader'
    runner = 'BaseRunner'
    extra_log_args = ['emb_size', 'gamma', 'c1', 'c2', 'cost']
    ...
    def forward(self, feed_dict):
        ...
        quantized = self.c5.quantize(item_e, with_loss=True)
        item_e = item_e + self.c1 * quantized.mean
        ...
        if feed_dict['phase'] == 'train':
            ...
            out_dict['loss_q'] = quantized.loss
        return out_dict
    ...
    def loss(self, output):
        ...
        return loss + self.c2 * output['loss_q']
